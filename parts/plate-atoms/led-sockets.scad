...
module led_sockets() {
  ...
  triangle_hulls() {
    led_corner_ne(0) plate_corner(); finger_corner_nw(0, 0) plate_corner();
    led_corner_se(0) plate_corner(); finger_edge_w(0, 0) plate_corner();
    led_corner_ne(1) plate_corner(); finger_corner_sw(0, 0) plate_corner();
  ...
  difference() {
    ...
    serial_hulls() {
      led_edge_n(0) translate([0, 0, 0]) scale([1, 1, 1]) plate_edge(horizontal=true);
      led_edge_s(0) translate([0, 0, 0]) scale([1, 1, 1]) plate_edge(horizontal=true);
      led_edge_n(1) translate([0, 0, 0]) scale([1, 1, 1]) plate_edge(horizontal=true);
      led_edge_s(1) translate([0, 0, 0]) scale([1, 1, 1]) plate_edge(horizontal=true);
      led_edge_n(2) translate([0, 0, 0]) scale([1, 1, 1]) plate_edge(horizontal=true);
      led_edge_s(2) translate([0, 0, 0]) scale([1, 1, 1]) plate_edge(horizontal=true);
      led_edge_n(3) translate([0, 0, 0]) scale([1, 1, 1]) plate_edge(horizontal=true);
      led_edge_s(3) translate([0, 0, 0]) scale([1, 1, 1]) plate_edge(horizontal=true);
